...
const BlogPage: React.FC<BlogPageProps> = ({ onNavigateToMain }) => {
  ...
  const handleNavItemClick = (sectionId: string) => {
    if (sectionId === 'start' || sectionId === 'vision' || sectionId === 'aliyah' || 
        sectionId === 'mission' || sectionId === 'project' || sectionId === 'support' || 
        sectionId === 'founder' || sectionId === 'contact') {
      onNavigateToMain();
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <NavBar 
        ...
        onNavigateToBlog={handleNavItemClick}
      />
